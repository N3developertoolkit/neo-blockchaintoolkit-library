...
namespace MessagePack.Formatters.Neo.BlockchainToolkit.TraceDebug
{
    ...
    public sealed class ResultsFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Neo.BlockchainToolkit.TraceDebug.Results>
    {


        public void Serialize(ref MessagePackWriter writer, global::Neo.BlockchainToolkit.TraceDebug.Results value, global::MessagePack.MessagePackSerializerOptions options)
        {
        ...
        public global::Neo.BlockchainToolkit.TraceDebug.Results Deserialize(ref MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::Neo.BlockchainToolkit.TraceDebug.Results(__State__, __GasConsumed__, __ResultStack__);
            reader.Depth--;
            return ____result;
        }
    }
