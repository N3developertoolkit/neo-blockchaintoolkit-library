...
namespace test.bctklib3
{
    public class PersistenceTest
    {
        ...
        public void TestSeek1Forward(IDisposableStorageProvider storageProvider, IDisposable? disposable)
        {
        ...
        [Theory, MemberData(nameof(SeekStores1))]
        public void TestSeek1Backwards(IDisposableStorageProvider storageProvider, IDisposable? disposable)
        {
            disposable ??= NoopDisposable.Instance;
        ...
        public static IEnumerable<object[]> SeekStores1
        {
            get
            {
                ...
                static object[] ConfigureStore(IDisposableStorageProvider provider, IDisposable? disposable)
                {
