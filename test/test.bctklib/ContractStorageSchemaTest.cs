...
namespace test.bctklib
{
    public class ContractStorageSchemaTest
    {
        ...
        [Fact]
        public void test_parse_array_struct()
        {
            ...
            var text = "Array<testStruct>";
            var map = new Dictionary<string, StructContractType>();
            map.Add(@struct.Name, @struct);
            ContractStorageSchema.TryParseContractType(text, map, out var actual).Should().BeTrue();

            var expected = new ArrayContractType(@struct);
            actual.Should()
                .NotBeNull()
                .And.Be(expected);
        }
        ...
        [Fact]
        public void test_parse_array_nested()
        {
            var text = "Array<Array<Address>>";
            var map = new Dictionary<string, StructContractType>();
            ContractStorageSchema.TryParseContractType(text, map, out var actual).Should().BeTrue();

            var expected = new ArrayContractType(new ArrayContractType(PrimitiveContractType.Address));
            actual.Should()
                .NotBeNull()
                .And.Be(expected);
        }
        ...
        public void test_parse_map_primitives()
        {
            ...
            var expected = new MapContractType(PrimitiveType.Address, PrimitiveContractType.Integer);
            actual.Should()
                .NotBeNull()
        ...
        public void test_parse_map_primitives_nested()
        {
            ...
            var expected = new MapContractType(
